...
%   %weights of the variables are included in this, not of the observations
%   
...
if ctrl
  w = w(:) / sum(w);  %normalises weights                                         % w is column vector
else
...
% C = Y- repeat copies of array w'Y. Size of new array is rows = T*rows(w'Y),
% columns = original coluns
